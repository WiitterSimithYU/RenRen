...
//
//  INVITEFriendViewCell.m
//  RenRen
//
//  Created by miaomiaokeji on 16/6/21.
//  Copyright © 2016年 Beyondream. All rights reserved.
//

#import "INVITEFriendViewCell.h"

@implementation INVITEFriendViewCell
...
-(void)InitCreate{
    ...
    diChengView.backgroundColor = [UIColor orangeColor];
    ...
    titleLab.textColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.9 alpha:1.0];
    ...
    fenhongLab.backgroundColor = [UIColor greenColor];
    ...
    timeLab.textColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.9 alpha:1.0];
