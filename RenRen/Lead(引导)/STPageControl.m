...
#define  gapWidthDefault  7*(SCREEN_WIDTH/320)
static CGFloat const  lineWidthDefault = 1;
#define  diameterDefault  7*(SCREEN_WIDTH/320)

#define  gapWidthSystem   7*(SCREEN_WIDTH/320)
static CGFloat const  lineWidthSystem  = 1;
#define   diameterSystem   7*(SCREEN_WIDTH/320)
/**
 *  1.初始化
 */
...
- (void)setDefaultUI{
    ...
    _gapWidth  = 7*(WidthPageControl/320);
    _diameter  = 7*(WidthPageControl/320);
...
+ (STPageControl * _Nonnull)pageControlWithFrame:(CGRect)frame numberOfPages:(NSInteger)numberOfPages gapWidth:(NSInteger)gapWidth diameter:(NSInteger)diameter lineWidth:(NSInteger)lineWidth coreNormalColor:(UIColor *__nullable)coreNormalColor coreSelectedColor:(UIColor *__nullable)coreSelectedColor lineNormalColor:(UIColor *__nullable)lineNormalColor lineSelectedColor:(UIColor *__nullable)lineSelectedColor textNormalColor:(UIColor *__nullable)textNormalColor textSelectedColor:(UIColor *__nullable)textSelectedColor hidesForSinglePage:(BOOL)hidesForSinglePage ShowNumber:(BOOL)isShowNumber
{
    // 1.控件的最小的宽度
...
+ (STPageControl *)pageControlSystemWithFrame:(CGRect)frame numberOfPages:(NSInteger)numberOfPages pageIndicatorColor:(UIColor *)pageIndicatorColor currentPageIndicatorColor:(UIColor *)currentPageIndicatorColor
{
    return [STPageControl pageControlWithFrame:frame numberOfPages:numberOfPages
          gapWidth:gapWidthSystem
          diameter:diameterSystem
         lineWidth:lineWidthSystem coreNormalColor:pageIndicatorColor  coreSelectedColor:currentPageIndicatorColor lineNormalColor:pageIndicatorColor lineSelectedColor:currentPageIndicatorColor textNormalColor:[UIColor clearColor] textSelectedColor:[UIColor clearColor]hidesForSinglePage:NO
        ShowNumber:NO];
